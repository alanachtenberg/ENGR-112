...
int main(){
	...
	cout<<"You have "<<setw(6)<<cash[0]<<" dollar bills\n";// output in a list the number of bills, the purpose of setw(6) is to right allign the numbers up to 6 decimals
	cout<<"You have "<<setw(6)<<cash[1]<<" two dollar bills\n";
	cout<<"You have "<<setw(6)<<cash[2]<<" five dollar bills\n";
	cout<<"You have "<<setw(6)<<cash[3]<<" ten dollar bills\n";
	cout<<"You have "<<setw(6)<<cash[4]<<" twenty dollar bills\n";
	cout<<"You have "<<setw(6)<<cash[5]<<" fifty dollar bills\n";
	cout<<"You have "<<setw(6)<<cash[6]<<" hundred dollar bills\n\n";
